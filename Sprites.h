...
const unsigned char _perrystandleft_data[]={
	  ...
	  1,  2,0x40,0|OAM_FLIP_H,
	  8,  0,0x50,1|OAM_FLIP_H,
	  0,  0,0x51,1|OAM_FLIP_H,
	  8,  8,0x60,1|OAM_FLIP_H,

	  0,  8,0x61,1|OAM_FLIP_H,
	0x80

};

const unsigned char _perrywalright0_data[]={
...
const unsigned char _perrywalkleft0_data[]={
	  ...
	  8,  0,0x50,1|OAM_FLIP_H,
	  0,  0,0x51,1|OAM_FLIP_H,
	  8,  8,0x66,1|OAM_FLIP_H,

	  0,  8,0x67,1|OAM_FLIP_H,
	0x80
...
const unsigned char _perrywalkleft2_data[]={
	  ...
	  8,  0,0x50,1|OAM_FLIP_H,
	  0,  0,0x51,1|OAM_FLIP_H,
	  8,  8,0x64,1|OAM_FLIP_H,

	  0,  8,0x65,1|OAM_FLIP_H,
	0x80
